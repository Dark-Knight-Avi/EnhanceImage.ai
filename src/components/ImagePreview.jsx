  ...
  return (
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
        ...
        <div className="bg-white shadow-lg rounded-xl overflow-hidden">
            ...
            {loading ? <Loading /> : (<div className="flex justify-center items-center bg-gray-200 min-h-80 h-full w-full">No image enhanced!</div>)}
            {enhanced && !loading && (<img src="" alt="" className="w-full h-full object-cover"/>)}
        </div>
    </div>
  )
}
